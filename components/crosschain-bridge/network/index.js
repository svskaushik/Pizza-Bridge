  ...
  return (
    <Modal
      ...
      buttonTitle={chain ?
        ...
        :
        chains_data ?
          <div className="flex justify-center items-center w-48 bg-gray-50 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 rounded-3xl shadow uppercase text-gray-500 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-400 text-lg font-medium py-2 px-4">Chain <AiOutlineDown /></div>
          :
